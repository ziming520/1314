...
public class StandardAction extends ActionSupport implements
	...
	public String pageQuery() {
		// 调用业务层 ，查询数据结果
		// PageRequest 的 的 page 页码从 0 开始,而从ajax传过来的page 页码从 1 开始
	...
	public String findAll() {
		...
		// ActionContext.getContext()获得当前线程的ActionContext实例(单例模式,线程绑定)
		// 栈结构:在栈底部压栈存,取元素按条件从栈顶向下直到取到该元素或者确认栈中没有该元素;分为对象栈和map栈
